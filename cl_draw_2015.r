...
awayteams <- c("real", "wolfsburg","atletico","city",    "barcelona","bayern", "chelsea","zenit")  
hometeams <- c("psg",  "psv",      "benfica" ,"juventus","roma"     ,"arsenal","kiev",   "gent")
...
constraints2 <- matrix(data=NA,nrow=3,ncol=2)   # adjust nrow to the amount of constraints you put in below
constraints2[1,] <- c("arsenal","city")
constraints2[2,] <- c("arsenal","chelsea")
constraints2[3,] <- c("kiev","zenit")
...
simulations <- 1000000        # Set the amount of desired "good" simulations.
